...
import com.wynndie.spwallet.sharedCore.presentation.controller.localization.AndroidLocalizationController
...
actual val corePlatformModule: Module = module {
    ...
    single<LocalizationController> { AndroidLocalizationController(androidContext()) }
}