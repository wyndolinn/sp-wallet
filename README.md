...
### Безопасность
Данные карт никуда не передаются, а храняться исключительно на вашем устройстве в кеше приложения
...
### Помогите приложению попасть в Play Market
1. Войдите в гугл группу тестирования по [ссылке](https://groups.google.com/u/1/g/sp-wallet-testers), чтобы иметь возможность скачать приложение
2. Установите приложение из плей маркета по [ссылке](https://play.google.com/store/apps/details?id=com.wynndie.spwallet)
3. Можете оставить фидбек в личные сообщения или разделе [проблемы](https://github.com/wyndolinn/sp-wallet/issues)
